...
data = np.genfromtxt('G:\My Drive\MSEE\Master_Thesis\Diabetes_Prediction\Jupyter Notebooks\ANFIS Implementation\anfis_code\input\binary_no-head_BMI-AGE-Income-PhysHlth_300x4.csv', delimiter=',')  
